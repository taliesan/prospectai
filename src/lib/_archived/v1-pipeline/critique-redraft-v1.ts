// ──────────────────────────────────────────────────────────────────────
// ARCHIVED: V1 critique-redraft prompt assembly path
// This was the original 6-layer editorial prompt used in
// buildCritiqueRedraftPrompt() before V2 switched to extracting
// sections from critique-editorial-v2.txt.
// The V1 path included an explicit bleed check naming Newmark,
// Bahat, and McGlinchey.
// ──────────────────────────────────────────────────────────────────────

import type { LinkedInData } from '../../prompts/extraction-prompt';

/**
 * V1 critique-redraft prompt assembly — the else branch from buildCritiqueRedraftPrompt().
 */
export function buildCritiqueRedraftPromptV1(
  donorName: string,
