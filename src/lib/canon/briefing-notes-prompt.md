# BRIEFING NOTES — PROMPT ARCHITECTURE

This prompt has three sections. Read all three before writing.

1. **SCHEMA** defines the five sections, their headings, and the prioritization rule that governs what belongs on the page.

2. **EXEMPLARS** are Briefing Notes for three fictional characters from the profiles you've already seen: a pirate captain, a sentient octopus, and a mycorrhizal network. They demonstrate what survives the reduction and what doesn't. Learn the prioritization moves. Nothing from these exemplars belongs in your output.

3. **TASK** tells you what to write.

The full profile is already in this conversation. You wrote it. The Briefing Note is a reduction of that profile — not a summary, not a compression, but a prioritization. The question is not "how do I fit everything onto one page?" The question is "what are the minimum set of truths someone needs in order to recognize this donor correctly in under a minute?"
...
A line belongs on the Briefing Note only if it does one of these things:
...
Everything else is explanation. Explanation belongs in the full profile.

If it doesn't help someone recognize, interpret, or place the donor quickly, it doesn't belong on the Briefing Note.

## Format

- Bullet points throughout.
- Each bullet is 1-3 sentences. Dense, plain, behavioral.
- 3-5 bullets per section. Fewer is fine if the evidence is thin. More is not fine.
- No headers within sections. No sub-bullets. No bold text within bullets.
- Profile only. No meeting choreography, no "what to do next," no call structure. The Briefing Note says "this is who this person is and how they behave." It does not say "here is your operating procedure."
- Target length: 400-450 words. Nothing over 500.

## Register

The same register rules from the full profile apply here. Biography into behavioral force. Traits into observable behavior. Values into stress-tested choices. No performative insight. No literary construction. No methodology vocabulary. Every sentence must be plain, specific, and immediately usable.

The Briefing Note is even less tolerant of decoration than the full profile because there is no room for it. If a sentence sounds impressive but doesn't change what the reader does, cut it.

---

# 2. EXEMPLARS

The following three Briefing Notes demonstrate the reduction from full profile to one-page artifact. They are for the same fictional characters as the profile exemplars. They exist to show you what survives the cut, what gets dropped, and how each section earns its space at this length. Nothing from these exemplars belongs in your output.

═══════════════════════════════════════════════════════════════════════

## EXEMPLAR 1 — High-evidence subject, personal operator
...
- Shuts down around vagueness, flattery before a request, and anyone who romanticizes piracy without knowing what salt water does to a hull.
...
- When she commits, the terms are in the ledger. If you resist putting terms in writing, she reads that as intent to renegotiate later.

═══════════════════════════════════════════════════════════════════════

## EXEMPLAR 2 — High-evidence subject, transparent and teaching-driven
...
- Her commitment model is apprenticeship: long, close, and built through shared observation over time. She doesn't fast-track relationships and doesn't do group affiliations.
- When she commits, she is allocating working time, research capacity, and hours in the water. Don't mistake that for casual interest.
- She does not use paperwork as a substitute for trust.

═══════════════════════════════════════════════════════════════════════

## EXEMPLAR 3 — Low-evidence subject, institutional operator
...
- Shuts down around urgency. She cannot accelerate and urgency asks her to bypass protocols she built to keep experience from overriding judgment.
- Unverified data presented as confirmed is a hard stop. She has rerouted active exchanges rather than pass numbers she could not verify. The damage is immediate.
...
- High initial threshold, minimal renewal friction. The initial investment is where all the effort goes. After that, the relationship sustains itself through infrastructure she's already grown.
...
Write a Briefing Note for the donor you just profiled in this conversation.

## What you have

The full profile is in this conversation's history. You wrote it. Use it as the source. The Briefing Note is a prioritized reduction of that profile — not a rewrite from the research, not a parallel analysis, not a new interpretation. It preserves the truths that matter most and drops everything else.

## What to do

1. Read the full profile you just wrote.
2. Identify the load-bearing truths: the core operating logic, the central contradiction or tension, the sharpest behavioral reads, the hardest shutdown triggers, the clearest live tells, and the most natural role.
3. Write the Briefing Note using the five-section schema above.
4. Pressure-test every bullet: does this help someone recognize, interpret, or place the donor quickly? If not, cut it.

## What not to do

- Do not compress. Prioritize. Compression tries to fit everything into less space. Prioritization asks what survives a brutal cut.
- Do not drift into meeting guide territory. The Briefing Note says who the donor is and how they behave. It does not say what to do about it.
- Do not import content from the exemplars. They teach architecture only.
- Do not add anything that isn't in the full profile. The Briefing Note is a strict subset.
- Do not exceed 500 words.

Title the document: `# BRIEFING NOTE — [TARGET NAME]`
