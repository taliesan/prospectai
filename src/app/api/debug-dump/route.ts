...
const FILE_DESCRIPTIONS: Record<string, { path: string; label: string; group: string }> = {
  ...
  // Briefing Note (Turns 5-6 + BN Professor)
  'v5-turn5-bn-user':       { path: '/tmp/prospectai-outputs/V5-turn-5-bn-user.txt', label: 'Turn 5 user (BN Draft)', group: 'V5 Conversation — Briefing Note' },
  'v5-turn5-bn-response':   { path: '/tmp/prospectai-outputs/V5-turn-5-bn-response.txt', label: 'Turn 5 response (BN Draft)', group: 'V5 Conversation — Briefing Note' },
  'v5-bn-professor-prompt':  { path: '/tmp/prospectai-outputs/V5-bn-professor-prompt.txt', label: 'BN Professor prompt', group: 'V5 Conversation — Briefing Note' },
  'v5-bn-professor-feedback':{ path: '/tmp/prospectai-outputs/V5-bn-professor-feedback.txt', label: 'BN Professor feedback', group: 'V5 Conversation — Briefing Note' },
  'v5-turn6-bn-user':       { path: '/tmp/prospectai-outputs/V5-turn-6-bn-critique-user.txt', label: 'Turn 6 user (BN Critique)', group: 'V5 Conversation — Briefing Note' },
  'v5-turn6-bn-response':   { path: '/tmp/prospectai-outputs/V5-turn-6-bn-critique-response.txt', label: 'Turn 6 response (Final BN)', group: 'V5 Conversation — Briefing Note' },
  // Meeting Guide (Turns 7-9)
  ...
  'v5-turn7-user':    { path: '/tmp/prospectai-outputs/V5-turn-7-org-user.txt', label: 'Turn 7 user (Org Frame)', group: 'V5 Conversation — Meeting Guide' },
  'v5-turn7-response':{ path: '/tmp/prospectai-outputs/V5-turn-7-org-response.txt', label: 'Turn 7 response (Org Frame)', group: 'V5 Conversation — Meeting Guide' },
  'v5-turn8-user':    { path: '/tmp/prospectai-outputs/V5-turn-8-guide-user.txt', label: 'Turn 8 user (Guide Draft)', group: 'V5 Conversation — Meeting Guide' },
  'v5-turn8-response':{ path: '/tmp/prospectai-outputs/V5-turn-8-guide-response.txt', label: 'Turn 8 response (Guide Draft)', group: 'V5 Conversation — Meeting Guide' },
  'v5-turn9-user':    { path: '/tmp/prospectai-outputs/V5-turn-9-critique-user.txt', label: 'Turn 9 user (Guide Critique)', group: 'V5 Conversation — Meeting Guide' },
  'v5-turn9-response':{ path: '/tmp/prospectai-outputs/V5-turn-9-critique-response.txt', label: 'Turn 9 response (Final Guide)', group: 'V5 Conversation — Meeting Guide' },
